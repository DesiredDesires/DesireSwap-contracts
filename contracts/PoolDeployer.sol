...
contract PoolDeployer is IPoolDeployer {
  ...
  function deployPool(
    ...
    poolAddress = address(new DesireSwapV0Pool(factory_, swapRouter_, tokenA_, tokenB_, fee_, ticksInRange_, sqrtRangeMultiplier_, sqrtRangeMultiplier100_, name_, symbol_));
  }
}
